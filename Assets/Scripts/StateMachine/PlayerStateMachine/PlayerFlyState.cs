...
public class PlayerFlyState : MonoBehaviour// BaseState<PlayerState>
{
    ...
    // public PlayerFlyState(PlayerStateMachine player, PlayerState stateKey)
    // {
    //     this.player = player;
    //     StateKey = stateKey;
    // }
    ...
    // public override float CurrentState()
    // {
    //     throw new NotImplementedException();
    // }
